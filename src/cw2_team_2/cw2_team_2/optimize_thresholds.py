...
def optimize_thresholds(torque_file, contact_file):
    # 加载数据
    ...
    for leg_idx in range(4):
        ...
        foot_contact = contact_data.iloc[:, contact_cols[leg_idx]].astype(int)
        ...
        plt.plot(contact_time, foot_torque, 'k', label="Torque")
...
if __name__ == "__main__":
    ...
    best_tau_down, best_tau_up = optimize_thresholds(torque_file, contact_file)