...
class Robot:
    ...
    def __init__(self, env, start_pos=(0.5, 0.5), start_angle=0, sensor_range=0.35, step_size=0.05):
        self.env = env
        ...
        self.follower = ObstacleFollower(self, follow_distance=self.sensor_range)  # 绑定绕障行为
